export default function Impressum() {
    return (
        <div className='impressum'>
            ...
            <p>DHBW Heidenheim<br/>
                Marienstraße 20<br/>
                89518 Heidenheim an der Brenz <br/>
            </p>
            <p><strong>Vertreten durch: </strong><br/>
                DHBW Heidenheim an der Brenz<br/>
            </p><p><strong>Kontakt:</strong> <br/>
            Telefon: 07321-27220<br/>
            E-Mail: <a href='mailto:info@dhbw-heidenheim.de'>info@dhbw-heidenheim.de</a><br/></p><p>
