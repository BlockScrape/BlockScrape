...
from user_server.dependencies.server_information import set_server_con_string, get_server_con_string
import requests
...
set_server_con_string(uri=str(args['authentication_uri']))
